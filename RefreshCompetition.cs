    ...
    public class RefreshCompetition
    {
        ...
        public class DatabaseHelper
        {
            public void FillDataGridViewWithData(DataGridView dataGridView, string query)
            {
                ...
                using (SqlConnection con = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=\"C:\\Users\\limli\\Desktop\\IOOP\\WindowsFormsApp2\\Work\\Assignment 1\\Assignment 1\\Database1.mdf\";Integrated Security=True"))
                {
                    con.Open();
                    using (SqlCommand cmd = new SqlCommand(query, con))
                    {
